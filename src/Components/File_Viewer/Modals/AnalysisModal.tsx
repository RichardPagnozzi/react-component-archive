...
export const AnalysisModal = (props: ModalProps) => {
                ...
                <Card sx={boxStyle}>
                    <CardContent>
                        ...
                        <Grid container spacing={2} columns={12}>
                            ...
                            <Grid item xs={4}>
                                <ModalButton1 label={ButtonLabels[6]} onClickFunction={onButton7Click} />
                            </Grid>
                            <Grid item xs={4}>
                                <ModalButton1 label={ButtonLabels[7]} onClickFunction={onButton8Click} />
                            </Grid>
                        </Grid>
                    </CardContent>
                </Card>
